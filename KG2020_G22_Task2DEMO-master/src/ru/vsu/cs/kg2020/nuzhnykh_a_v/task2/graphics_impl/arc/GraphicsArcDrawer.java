...
public class GraphicsArcDrawer implements ArcDrawer {
    ...
    @Override
    public void drawArc(int x, int y, int width, int height, double startAngle, double sweepAngle, Color c) {
        Arc2D arc = new Arc2D.Double(x, y, width, height, startAngle*180/Math.PI, sweepAngle*180/Math.PI, Arc2D.OPEN);
